        ...
        <div className="grid md:grid-cols-3 gap-10 text-sm items-start text-center md:text-left">
          ...
          <div className="space-y-3">
            ...
            <form className='flex flex-col items-center justify-center md:flex-row w-full'>
                    ...
                    <button
                        type="submit"
                        className="bg-gradient-to-r from-pink-400 via-orange-300 to-yellow-300 text-black font-semibold px-6 py-3 rounded-r-xl shadow-md hover:opacity-90 transition"
                    >
                        Subscribe
                    </button>
                </form>
